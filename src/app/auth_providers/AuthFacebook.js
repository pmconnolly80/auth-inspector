    ...
    .service('AuthFacebook', function($window, $q, AuthResultsManager, ConfigManager,
      ...
      var info = {
        ...
        intro: {
          ...
          inYourCode: ['Include the <a href="https://developers.facebook.com/docs/javascript">Facebook JavaScript SDK</a> that will help you authenticate your users with their Facebook account and make requests to the Facebook API.',
