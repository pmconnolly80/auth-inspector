    ...
    .service('AuthGoogle', function($window, AuthResultsManager, ConfigManager, GAPI_CLIENT_SCOPE_BASIC_PROFILE, GAPI_CLIENT_SCOPE_GPLUS_PROFILE, GAPI_CLIENT_SCOPE_GMAIL_READONLY) {
      ...
      var info = {
        ...
        intro: {
          ...
          inYourCode: ['Include the <a href="https://developers.google.com/api-client-library/javascript/">Google JavaScript client library</a> to authenticate your users with their Google account.',
